...
{
    [Serializable]
    public class AnimationClipSet : IAddressableAssetProvider<AnimationClip>
    {        
        ...
        public AssetReferenceAnimationClip animationClipRef;

        [HorizontalGroup("Anim", Width = 0.2f)]
        [HideLabel]
        [SuffixLabel("X", overlay: true)]
        public float speed = 1;

        public bool UseAddressable => useAddressable;
        public AnimationClip DirectAsset => animationClip;
        public AssetReferenceT<AnimationClip> AssetReference => animationClipRef;
        ...
        [ReadOnly]
        [HideInEditorMode]
        public AnimationClip CachedAddressableAsset { get; set; }
        ...
        public AnimationClip AnimationClip_Editor
        {
            ...
            {
                if (useAddressable)
                    return animationClipRef.editorAsset;
                else
                    return AnimationClip;
            }
        }
    ...
    public class AnimationEventEditor
    {
        ...
        public void GetAnimationEvents(AnimationClipSet clipSet)
        {
            _clipSet = clipSet;
    ...
    public class AnimationEventCompleteValidator
    {
        ...
        public void SetVariable(string aePresetPath, AnimationClipSet clipSet)
        {
